        ...
        {tech.map((item, i) => (
          <div
            ...
            className={cn(
              ...
              item === "Next Js" && "border border-black/60",
              item === "Node Js" && "border border-green-500/60",
              item === "Bootstrap" && "border border-gray-500/60",
              ...
              item === "Figma" && "border border-blue-500/60",
              item === "GIT" && "border border-orange-500/60",
              item === "SQL" && "border border-purple-500/60",
              item === "AWS" && "border border-yellow-500/60",
              item === "Wordpress" && "border border-yellow-500/60",
              item === "C++" && "border border-red-500/60",
              item === "C" && "border border-green-500/60",
              item === "Github" && "border border-purple-500/60",
              item === "Matplotlib" && "border border-red-500/60",
